...
const ReviewsContent = () => {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const res = await API.get(
        `/reviews?user=${user?._id}&page=${page}&limit=${limit}`,
      );
  ...
  if (loading && reviews.length === 0)
    return <div style={{ fontSize: "1.6rem" }}>Loading reviews...</div>;
                    ...
                    {isEditing ? (
                      ...
                      <>
                        ...
                        <p style={{ fontSize: "1.4rem", color: "#777" }}>
                          <strong style={{ color: "#55c57a" }}>Rating:</strong>{" "}
                          {review.rating}/5 &bull;{" "}
                          <strong style={{ color: "#55c57a" }}>Date:</strong>{" "}
